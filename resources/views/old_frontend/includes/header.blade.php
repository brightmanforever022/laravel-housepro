...
$(document).ready(function() {
 ...
 if($( window ).width() >= 748)
 {
   $('#block123').vide({
      ...
      // poster:"{{ url('/') }}/video/ocean_123.jpg",
  });
 }else {
...
<div class="video-banner" id="block123"  data-vide-options="position: 50% 50%">
                ...
                {!! Form::open(array('url' => '/search', 'id' => 'index_search', 'method' => 'post')) !!}
                	<!--form class="wow bounceInUp" data-wow-duration="2s"-->
                    	<ul>
                            ...
                            <!--input type="text" name="city_where_met" id="city_where_met" placeholder="e.g.. Zurich,Luzern" /--></li>
                            <li>
                         ...
                         <h2 style="color:white" id="location_search">@if (Session::has('message1'))
