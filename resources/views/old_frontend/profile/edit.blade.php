            	...
            	<div class="steps-box min-height-577">
                    ...
                    <fieldset>
                    	<div class="row">
                            ...
                            <div class="col-md-6 res-mart-30">
                    			<input type="text" name="    additional_address" placeholder="Additional adress" value="{!! $user_data[0]->additional_address !!}"/>
                            </div>
                        </div>
                    </fieldset>
                    <fieldset>
                    	<div class="row">
                        	<div class="col-md-6">
                    			<input type="text" name="place" placeholder="PLZ Place*" value="{!! $user_data[0]->place !!}"/>
                            </div>
                            <div class="col-md-6 res-mart-30">
                    			<div class="select-icon">
                                    <select name="country">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="steps-box min-height-800">
                    ...
                    <fieldset>
                        <input type="text" name="paypal_email" id="paypal_email" placeholder="Email" value="{{$user_data[0]->paypal_email}}"/>
