...
<div class="popup" id="register">
    ...
    <form role="form" method="POST" id="form_register" action="{{ url('/') }}/postRegister" novalidate="novalidate">
    {{ csrf_field() }}
    	<fieldset>
        	<input type="text" placeholder="Company*" name="company"/>
        </fieldset>
        <fieldset>
        	<input type="text" placeholder="Name*" name="name" onkeypress="return lettersOnly(event);"/>
        </fieldset>
        <fieldset>
        	<input type="text" placeholder="Surname*" name="surname" onkeypress="return lettersOnly(event);"/>
        </fieldset>
        <fieldset>
        	<input type="text" placeholder="Phone*" name="phone" id="phone" onkeypress="return numbersOnly(event);"/>
        ...
        <fieldset>
            <input type="text" placeholder="City*" name="city" onkeypress="return lettersOnly(event);"/>
        </fieldset>
        <fieldset>
            <input type="text" placeholder="Zipcode*" name="zipcode" onkeypress="return numbersOnly(event);"/>
        </fieldset>
        <fieldset>
...
<div class="popup" id="register_user">
    ...
    <form role="form" method="POST" id="form_register_user" action="{{ url('/') }}/postRegister" novalidate="novalidate">
    {{ csrf_field() }}
        <fieldset>
            <input type="text" placeholder="Name*" name="name" onkeypress="return lettersOnly(event);"/>
        </fieldset>
        ...
        <fieldset>
            <input type="text" placeholder="Phone*" name="phone" id="phone_user" onkeypress="return numbersOnly(event);"/>
