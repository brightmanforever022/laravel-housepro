    ...
    <?php 
         ...
         $amount = $properties[0]->booking->booking->nights * $properties[0]->price_per_night;

         $final_amount = ($properties[0]->cleaning_fee + $amount) -  ($properties[0]->booking->initial);
    ?>
    <body>
    <div class="container">
        ...
        <div class="customer-info">
            <h1>{{ $booked_user[0]->saluation }}<br>{{ $booked_user[0]->name }} {{ $booked_user[0]->surname }}<br>{{ $booked_user[0]->address }}<br>@if ($booked_user[0]->city != NULL && $booked_user[0]->zipcode != NULL){{ $booked_user[0]->zipcode }} {{ $booked_user[0]->city }} @endif</h1>
        </div>
        ...
        <div class="invoice-detail">
            <table>
                <tr>
                    ...
                    <th width="25%">Nights</th>
                    <th width="27%">Price / Night</th>
                ...
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>{{ $properties[0]->cleaning_fee }} CHF</td>
                </tr>
                
                <tr>
                    <td>3</td>
                    <td>Deposit (paid by Paypal)</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
        ...
        <div class="invoice-detail-bottom">
            <table>
                <tr>
                    ...
                    <td width="25%">&nbsp;</td>
                    <td width="27%">&nbsp;</td>
                    <td width="13%"><strong>{{ number_format($final_amount, 2) }} CHF</strong></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
        ...
        <div class="container">
            <table>
                ...
                <tr>
                    ...
                    <td>IBAN @if ($host_user[0]->account) {{ $host_user[0]->account->iban }} @endif</td>
                    <td>@if ($host_user[0]->account) @if ($host_user[0]->account->vat_number != NULL){{ $host_user[0]->account->vat_number }} @else &nbsp; @endif @endif</td>
                        
                </tr>
                <tr>
                    <td>{{ $host_user[0]->address }}</td>
                    <td>BIC @if ($host_user[0]->account) {{ $host_user[0]->account->bic }} @endif</td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        @if ($host_user[0]->zipcode)
                            {{ $host_user[0]->zipcode }} {{ $host_user[0]->city }}
                        @else
                            {{ $host_user[0]->place }}
                        @endif
                    </td>
                    <td>BLZ @if ($host_user[0]->account) {{ $host_user[0]->account->blz }} @endif</td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
