...
<style>
    .fc-event {
        background-color: #f45559 !important;
    }
    .fc-event {
        border: 1px solid #f45559;
    }
</style>
            ...
            <div class="col-md-4">
                <div class="steps-box">
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="hidden" name="drop_ranges" id="drop_ranges" value="">
                                <input type="hidden" name="unselected" id="unselected" value="">
                                <input type="hidden" name="delete_dates" id="delete_dates" value="">
                    ...
                    <fieldset>
                     ...
                     {{-- <fieldset>
                          <input type="text" name="vat_number" placeholder="VAT registration number.*" value="{!!  $properties[0]->vat_number  !!}"/>
                    </fieldset> --}}
                    <fieldset>
