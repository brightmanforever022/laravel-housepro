...
body{margin:0;font-family:Arial,Helvetica Neue,Helvetica,sans-serif;font-size:13px;line-height:20px;color:#333;background-color:#f2f2f2}
...
hr{margin:30px 0;border:0;border-top:1px solid #eee;border-bottom:1px solid #fff}
...
@font-face {
    ...
    src: url('fonts/kalinga.eot?#iefix') format('embedded-opentype'),
         ...
         url('fonts/kalinga.ttf') format('opentype');
    font-style: normal;
    font-weight: normal;
}
table.content{width: auto;margin: 0 auto;}
.btn{width: 70%;border-radius: 0;border: 0;background: none;box-shadow: none;color: #fff;text-shadow: 0 1px 1px rgba(255,255,255,0.1);margin-top: 20px;padding: 10px 10px;}
.btn:hover{color: #ccc;}
.btn.accept{background: #fb5252;}
.btn.reject{background: #233336;}
.btn.success{background: #62c87f;}
hr {border-top: 0;border-bottom: 1px solid #8b9294;}
.navbar .brand{padding: 40px 20px 36px;}
.navbar {background: #fff;}
h2{font-weight: normal;margin-top: 15px;}
h3{font-weight: normal;}
p{margin-bottom: 15px;}
.footer img {padding: 0 5px;}
@media (max-width: 768px) {.container,.navbar-static-top .container,.navbar-fixed-top .container,.navbar-fixed-bottom .container{width: 100%;}}
    ...
    <table cellspacing="0" cellpadding="0" border="0" width="100%">
        <tr>
            <td class="navbar navbar-inverse" align="center">
                ...
                <table  align="center" width="650px" cellspacing="0" cellpadding="3" class="container">
                    <tr class="navbar navbar-inverse">
                        <td align="center"><a class="brand" href="{{ url('/') }}"><img src="{{ $message->embed('img/logo.png') }}"></a></td>
                    </tr>
                </table>
            </td>
        </tr>
        <tr>
            <td bgcolor="#243336" align="center">
                <h2 style="color:#fff;">Congratulation! Your reservation has been confirmed by the provider.</h2>
                <p style="color:#fff;">You find all details about your reservation under <font style="color:#fb5252;">Bookings</font></p>
            </td>
        </tr>
        <tr>
            <td bgcolor="#f2f2f2" align="center">
                <table cellspacing="0" cellpadding="3" class="container">
                    <tr>
                        <td align="center"><h3 style="color:#243336;margin:30px 0;font-weight:normal;">from</h3></td>
                    </tr>
                    <tr>
          ...
          @if($host_image == "")
          <td align="center"><img style="border-radius: 50%;" src="{{ $message->embed('img/photo.png') }}"></td>
          @else
          <td align="center"><img style="border-radius: 50%;" src="{{ $message->embed($host_image) }}"></td>
          @endif
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td align="center">
                            <h3 style="margin-bottom:0;color:#243336;">{{ $company }}</h3>
                        </td>
                    </tr>
                    <tr>
                        <td align="center" style="color:#243336;">
                            (Member since {{ date('D, d. F Y',strtotime($created_at))}})
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <p style="color:#2e2e2e;background: #fff;padding: 15px;line-height: 2em;margin-top:50px;margin-bottom:20px;">Guten Tag<br>
                                Ihre Buchung wurde soeben von Anbieter Ihrer Wahl bestätigt. Wir wünschen Ihnen einen guten Aufenthalt. Für weitere Anliegen oder Fragen, nehmen Sie bitte direkt mit dem Anbieter Kontakt auf. Die Adresse finden Sie hier.
                                <br><br>
                                <font style="display:block;text-align:center;">{{ $company }}</font>
                                <font style="display:block;text-align:center;">{{ $address }}</font>
                                <font style="display:block;text-align:center;">{{ $place }}</font>
                                <font style="display:block;text-align:center;">Tel.+41 {{ $phone }}</font><br>
                            </p>
                        </td>
                    </tr>
                    <tr>
                       <td>
                        @if($property_image == "")
      <img src="{{ $message->embed('img/image1.jpg') }}">
      @else
      <img src="{{ $message->embed($property_image) }}">
      @endif
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#fff" style="padding:15px;font-family:'Kalinga';background-color:#fff;">
                            <table width="100%">
                                <tr>
                                    <td style="font-weight:bold;">{{$title}}, <font style="font-style:italic;">{{$street}}, {{$plz_place}}</font></td>
                                </tr>
                                <tr>
                                    <td style="padding-top:20px;">
                                        <table width="100%">
                                            <tr style="font-weight: bold;">
                                                <td style="padding: 7px 0;">Check In</td>
                                                <td>Check Out</td>
                                                <td>Total Amount</td>
                                                <td>Paid Deposit</td>
                                            </tr>
                                            <tr>
                                                <td width="25%">{{ date('D, d. F Y',strtotime($check_in))}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                <td width="25%">{{ date('D, d. F Y',strtotime($check_out))}}</td>
                                                <td width="25%">CHF {{$price}} ({{$nights}} Nights)</td>
                                                <td width="25%" style="color:#62c87f;">CHF {{$initial}}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding-top: 10px"><a href="javascript:void(0);"><img src="{{ $message->embed('img/confirm.png') }}"></a></a>
                                                </td>
                                                <td  style="padding-top: 10px"><a href="{!! $attach !!}"><img src="{{ $message->embed('img/Booking-PDF.png') }}"></td>
                                                <td></td>
                                                <td></td>
                                            </tr>
                                        </table>
        ...
        <tr>
            <td bgcolor="#f2f2f2" align="center">
                <table width="100%" align="center" class="container">
                    ...
                    <tr>
                        <td>
                            <table bgcolor="#f2f2f2" width="100%" class="footer">
                                <tbody>
                                    <tr>
                                        <td  bgcolor="#f2f2f2" align="center" style="padding-top:20px;">
                                            <a href="#"><img src="{{ $message->embed('img/fb.png') }}" /></a>
                                            <a href="#"><img src="{{ $message->embed('img/google.png') }}" /></a>
                                            <a href="#"><img src="{{ $message->embed('img/instagram.png') }}" /></a>
                                            <a href="#"><img src="{{ $message->embed('img/pinterest.png') }}" /></a>
                                            <a href="#"><img src="{{ $message->embed('img/twitter.png') }}" /></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td bgcolor="#f2f2f2" align="center">
                                            <p style="margin-top:30px;font-family:'Kalinga';font-size:12px;color:#545454;">Von APARTOLINO versendet.<br>
