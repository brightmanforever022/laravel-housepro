...
.btn{width: 70%;border-radius: 0;border: 0;background: none;box-shadow: none;color: #fff;text-shadow: 0 1px 1px rgba(255,255,255,0.1);margin-top: 20px;padding: 10px 14px;}
.btn:hover{color: #ccc;}
    ...
    <table cellspacing="0" cellpadding="0" border="0" width="100%">
            ...
            <td class="navbar navbar-inverse" align="center">
                ...
                <table  align="center" width="650px" cellspacing="0" cellpadding="3" class="container">
                    <tr class="navbar navbar-inverse">
                        <td align="center"><a class="brand" href="[YOUR WEB URL]"><img src="{{ $message->embed('img/logo.png') }}"></a></td>
                    </tr>
                </table>
            </td>
        </tr>
        <tr>
            <td bgcolor="#243336" align="center">
                <h2 style="color:#fff;">You have a new booking request</h2>
                <p style="color:#fff;">Please answer the request within 24 hours</p>
            </td>
        </tr>
        <tr>
            <td bgcolor="#f2f2f2" align="center">
                <table  align="center" cellspacing="0" cellpadding="3" class="container">
                    <tr>
                        <td align="center"><h3 style="color:#243336;margin:30px 0;font-weight:normal;">{{ $company }}</h3></td>
                    </tr>
                    <tr>
                        <td  align="center">
                            <table class="content"  align="center">
                                <tr>
                                    <td  align="center"><img style="border-radius: 50% !important;" src="{{ $message->embed($host_image) }}"></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                            <h3 style="margin-bottom:0;color:#243336;">{{ $host_name }}</h3>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <p style="color:#2e2e2e;background: #fff;padding: 15px;line-height: 2em;margin-top:50px;margin-bottom:20px;">Hello<br>
                                {{ $remark }}
                                <br><br>
                                Best wishes, 
                            </p>
      ...
      @endif
                                ...
                                <tr>
                                    <td style="padding-top:20px;">
                                        <table width="100%">
                                            ...
                                            <tr>
                                                <td width="25%">{{ date('D, d. M. Y',strtotime($check_in))}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                <td width="25%">{{ date('D, d. M. Y',strtotime($check_out))}}</td>
                                                <td width="25%">CHF {{$price}} ({{$nights}} Nights)</td>
                                                <td width="25%" style="color:#62c87f;">CHF {{$initial}}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding-top:10px;"><a href="{{ url('/') }}/accept/{{$property_id}}"><img src="{{ $message->embed('img/accept.png') }}"></a></td>
                                                <td style="padding-top:10px;"><a href="{{ url('/') }}/reject/{{$property_id}}"><img src="{{ $message->embed('img/reject.png') }}"></a></td>
                                                <td></td>
                                                <td></td>
                                            </tr>
                                        </table>
        ...
        <tr>
            <td align="center" bgcolor="#f2f2f2">
                <table bgcolor="#f2f2f2" cellspacing="0" cellpadding="3" class="container">
                    <tr>
                        <td>
                            <hr>
                            <table width="100%" class="content">
                                <tbody>
                                    <tr>
                                        <td align="center">
                                            <img src="{{ $message->embed('img/email_out.png') }}" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center">
                                            <h1 style="color:#545454;">Respond within 24 hours</h1>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center">
                                            <p style="margin-bottom: 0;color:#545454;">
                                            Help plan the customer trip, please reply within 24 hours. If you need more than 24 hours for your reply, 
                                            it can have a negative effect on your reservation rate.
                                            </p>
                                        </td>
                                    </tr>
                                </tbody>
                    ...
                    <tr>
                        <td bgcolor="#f2f2f2">
                            <table bgcolor="#f2f2f2"  align="center" width="100%" class="footer">
                                <tbody>
                                    <tr>
