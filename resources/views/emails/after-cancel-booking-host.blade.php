    ...
    <table cellspacing="0" cellpadding="0" border="0" width="100%">
        ...
        <tr>
            <td bgcolor="#243336" align="center">
                <h2 style="color:#fff;">The current booking has been canceled.</h2>
                <p style="color:#fff;">The cancel fee will be deducted from paid deposit within 24h</p>
            </td>
        </tr>
        <tr>
                    ...
                    <tr>
                        <td>
                            <p style="color:#2e2e2e;background: #fff;padding: 15px;line-height: 2em;margin-top:50px;margin-bottom:20px;">Guten Tag<br>
                                Ihr Kunde hat die bestätigte Buchung innerhalb des zulässigen Zeitraums storniert. Die Stornierungsgebühr wird von der Anzahlung abgezogen und Ihnen innerhalb von 24h auf Ihr Paypal Konto Überwiesen. Nach Überweisung der Stonierungsgebühr, können Sie neue Buchungen für dieses Apartment erhalten.
								<br><br>Vielen Dank und einuen schönen Tag.
                                ...
                                <tr>
                                    <td style="padding-top:20px;">
                                        <table width="100%">
                                            ...
                                            <tr>
                                                <td style="padding-top: 10px"><a href="javascript:void(0);"><img src="{{ $message->embed('img/CANCELED.jpg') }}"></a></a>
                                                </td>
                                                <td></td>
                                                <td></td>
                                            </tr>
