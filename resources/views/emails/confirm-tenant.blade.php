...
.btn{width: 160px;border-radius: 0;border: 0;background: none;box-shadow: none;color: #fff;text-shadow: 0 1px 1px rgba(255,255,255,0.1);margin-top: 120px;padding: 10px 14px;margin-bottom: 80px;}
.btn:hover{color: #ccc;}
    ...
    <table cellspacing="0" cellpadding="0" border="0" width="100%">
        <tr>
            <td class="navbar navbar-inverse" align="center">
                ...
                <table width="650px" cellspacing="0" cellpadding="3" class="container" align="center">
                    <tr class="navbar navbar-inverse">
                        <td colspan="4" align="center"><a class="brand" href="[YOUR WEB URL]"><img src="{{ $message->embed('img/logo.png') }}"></a></td>
                    </tr>
                </table>
            </td>
        </tr>
        <tr>
            <td bgcolor="#243336" align="center">
                <h2 style="color:#fff;">Good day {{$name_up}}</h2>
                <p style="color:#fff;">please confirm your email address</p>
            </td>
        </tr>
        <tr>
            <td bgcolor="#f2f2f2" align="center">
                <table cellspacing="0" cellpadding="3" class="container" bgcolor="#f2f2f2">
                    <tr>
                        <td align="center">
                            <p style="margin-top:80px;color: #545454;">To confirm your email address, please click on the link below.<br>
                            Thank you very much.</p>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                            <a href="{{$link}}"><img style="background-color:#ff8080;border-radius:600px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:13px;font-weight:bold;line-height:100px;text-align:center;text-decoration:none;width:100px;-webkit-text-size-adjust:none;" src="{{ $message->embed('img/confirmred.png') }}"></a></a>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td bgcolor="#f2f2f2" align="center">
                <table width="100%" align="center" bgcolor="#f2f2f2" class="container">
                    <tr>
                        <td bgcolor="#f2f2f2"
                        >
                            <hr>
                            <table width="100%" class="content" bgcolor="#f2f2f2">
                                <tbody>
                                    <tr>
                                        <td align="center">
                                            <img src="{{ $message->embed('img/flow.png') }}" style="margin:60px 0;" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center">
                                            <h1 style="color:#545454;">Coordinate your account</h1>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center">
                                            <p style="margin-bottom: 0;color:#545454;">
                                            Gather right now your first listings and rent your apartments to prospective customers from home and abroad. Do you have questions when setting up your account or questions to detect the advertisements, <br>
                        ...
                        <td>
                            <table bgcolor="#f2f2f2" width="100%" class="footer">
                                <tbody>
                                    ...
                                    <tr>
                                        <td bgcolor="#f2f2f2" align="center">
                                            <p style="margin-top:30px;font-family:'Kalinga';font-size:12px;color:#545454;color: #545454;">Von APARTOLINO versendet.<br>
