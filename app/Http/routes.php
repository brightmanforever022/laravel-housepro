...
Route::get('/get-end-date', 'SearchController@getEndDateCalendar');
...
Route::get('/admin-password-setting', ['as' => 'admin.password.setting', 'uses' => 'AdminController@passwordSetting']);
Route::post('/admin-save-password-setting', ['as' => 'admin.save.password.setting', 'uses' => 'AdminController@savePasswordSetting']);
